...
import com.example.posts.presentation.utils.gone
import com.example.posts.presentation.utils.loadAvatar
import com.example.posts.presentation.utils.visible
...
class PostDetailsActivity : AppCompatActivity() {
    ...
    private val userId by lazy { intent.getStringExtra(Navigator.USER_ID_KEY) }
    private val postId by lazy { intent.getStringExtra(Navigator.POST_ID_KEY) }
